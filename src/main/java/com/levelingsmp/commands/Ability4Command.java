...
public class Ability4Command implements CommandExecutor {
    private final LevelingPluginSMP plugin;
    private final WeaponAbilityManager manager;

    public Ability4Command(LevelingPluginSMP plugin, WeaponAbilityManager manager) {
        this.plugin = plugin;
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        manager.activateSwordAbility(p);
        return true;
    }
}
